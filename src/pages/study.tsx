...
import { ArrowLeft, BookOpen, Clock, Target, ChevronRight, Sparkles, Ear, Gamepad2, Brain } from "lucide-react";
        ...
        <Card className="mb-6 bg-gradient-to-r from-blue-500 to-indigo-500 text-white border-none shadow-lg overflow-hidden">
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              ...
              <Link to={`/study/${sortedDecks[0].id}`}>
          ...
          {sortedDecks.map((deck) => (
            <Card key={deck.id} className="card-hover group overflow-hidden">
              ...
              <div className="flex items-center p-4 gap-4">
                ...
                {/* Action Button */}
                <Link to={`/study/${deck.id}`} className="shrink-0">
                  <Button 
                    className={cn(
                      "transition-all",
                      deck.progress === 100 
